<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\article\edit.html";i:1503903169;s:72:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\css.html";i:1503380362;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\header.html";i:1503389458;s:73:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\left.html";i:1505138620;s:71:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\js.html";i:1503380392;}*/ ?>
<!DOCTYPE html>
<html><head>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post"  enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" value="<?php echo $lst['title']; ?>"  placeholder="" name="title" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $lst['author']; ?>"   placeholder="" name="author" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                暂无缩略图
                                <?php else: ?>
                                <img style="float:left;" width="200px" src="/images/<?php echo $lst['pic']; ?>" alt="">
                                <?php endif; ?>
                                <input style="float:left;" class=""  placeholder="" name="pic" type="file">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <option value="<?php echo $vo['id']; ?>"  <?php if($lst['type'] == $vo['id']): ?>selected="select"<?php endif; ?> ><?php echo $vo['classname']; ?>
                                   </option>
