<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\aboutme\index.html";i:1503903237;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\header.html";i:1503389458;s:73:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\left.html";i:1503801988;}*/ ?>
<!DOCTYPE html>
<html><head>
          ...
          <div class="page-sidebar" id="sidebar">
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <a href="<?php echo url('aboutme/add'); ?>"><button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = ''> <i class="fa fa-plus"></i>Add
                    </button></a>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th width="20%" class="text-center">是否显示在个人简介</th>
