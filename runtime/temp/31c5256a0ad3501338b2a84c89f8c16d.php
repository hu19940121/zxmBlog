<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\article\index.html";i:1503903176;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\header.html";i:1503389458;s:73:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\left.html";i:1505138620;}*/ ?>
<!DOCTYPE html>
<html><head>
          ...
          <div class="page-sidebar" id="sidebar">
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <a href="<?php echo url('Article/add'); ?>"><button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = ''> <i class="fa fa-plus"></i>Add
                    </button></a>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th width="6%" class="text-center">作者</th>
                                             ...
                                             <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                   ...
                                                   <!--  <?php
                                                    ...
                                                    <td align="center">
                                                    <?php if($vo['pic'] != ''): ?>
                                                     <img width="200px" src="/images/<?php echo $vo['pic']; ?>" alt="">
                                                    <?php else: ?>
                                                    暂无缩略图
                                                    <?php endif; ?>
