<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\skillart\artdetail.html";i:1503903451;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\common\header.html";i:1503924613;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\common\footer.html";i:1503635158;}*/ ?>
<!doctype html>
<html>
<head>
 ...
 <header>
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box">
        <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>>><a href="#" target="_blank">文章详情</a></span><b>文章详情</b></h2>
        <div class="f_box">
      ...
      <a href="/index.php/index/skillart/artdetail?id=<?php echo $prev['id']; ?>">
      <?php echo $prev['title']; else: ?>
      没有了
      <?php endif; ?>
      </a></p>
      <p>下一篇：<?php if($next['id'] != ''): ?>
      <a href="/index.php/index/skillart/artdetail?id=<?php echo $next['id']; ?>">
