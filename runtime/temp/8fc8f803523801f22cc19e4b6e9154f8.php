<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\arclass\index.html";i:1503903193;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\header.html";i:1503389458;s:73:"C:\phpstudy\WWW\zxmblog\public/../application/admin\view\common\left.html";i:1505138620;}*/ ?>
<!DOCTYPE html>
<html><head>
          ...
          <div class="page-sidebar" id="sidebar">
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <a href="<?php echo url('arclass/add'); ?>"><button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = ''> <i class="fa fa-plus"></i>Add
                    </button></a>
                    <div class="row">
                                            ...
                                            <tbody>
                                             <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    ...
                                                    <td align="center"><?php echo $vo['classname']; ?></td>
                                                    <td align="center">
