<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\phpStudy\WWW\zxmblog\public/../application/admin\view\videos\index.html";i:1505137157;s:75:"C:\phpStudy\WWW\zxmblog\public/../application/admin\view\common\header.html";i:1503389458;s:73:"C:\phpStudy\WWW\zxmblog\public/../application/admin\view\common\left.html";i:1505138620;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
          ...
          <div class="page-sidebar" id="sidebar">
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <a href="<?php echo url('videos/add'); ?>"><button type="button" tooltip="添加视频" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = ''> <i class="fa fa-plus"></i>Add
                    </button></a>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th class="text-center">是否显示在主页</th>
                                             ...
                                             <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                   ...
                                                   <!--  <?php
                                                    ...
                                                    <td align="center">
                                                    <?php if($vo['vimg'] != ''): ?>
                                                     <img width="200px" src="<?php echo $vo['vimg']; ?>" alt="">
                                                    <?php else: ?>
                                                    暂无缩略图
                                                    <?php endif; ?>
