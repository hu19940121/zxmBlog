<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\diary\notes.html";i:1503903512;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\common\header.html";i:1504320312;s:75:"C:\phpstudy\WWW\zxmblog\public/../application/index\view\common\footer.html";i:1503635158;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="container">
  <div class="con_content">
    <div class="about_box">
      <h2 class="nh1"><span>您现在的位置是：<a href="/index.php/index/index/index" >网站首页</a>>><a href="#">个人笔记</a></span><b>个人笔记</b></h2>
      <div class="dtxw box">
      <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li class="wow flipInX  animated">
          <div class="dttext f_l">
            <ul>
              <h2><a href="/index.php/index/diary/nodetail?id=<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a></h2>
